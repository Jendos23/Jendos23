...
public class QuizEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Редактировать содержимое", GUILayout.Height(50))) QuestionWindow.ShowWindow();
        EditorGUILayout.Space();
        ...
        if (SceneManager.GetActiveScene().isDirty) EditorGUILayout.HelpBox("Не забудь сохранить проект!", MessageType.Warning);
        EditorGUILayout.Space();
        EditorGUILayout.BeginHorizontal("box");
